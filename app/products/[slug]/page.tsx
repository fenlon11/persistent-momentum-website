    ...
    <main className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950">
      ...
      <section className="pt-32 pb-16 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
        <div className="text-center">
          ...
          <p className="text-xl text-[#1E5BFF] font-medium mb-4">{product.tagline}</p>
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link
              ...
              className="inline-flex items-center gap-2 px-6 py-3 bg-[#1E5BFF] text-white font-semibold rounded-xl hover:scale-105 hover:shadow-2xl hover:shadow-[#1E5BFF]/50 transition-all duration-300"
            >
              View Pricing
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {product.features.map((feature) => (
            <div
              key={feature.title}
              className="bg-slate-800/50 border border-slate-700/50 rounded-xl p-6 hover:border-[#1E5BFF]/30 transition-all duration-300"
            >
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-3xl mx-auto text-center">
        <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 border border-slate-700/50 rounded-2xl p-8">
          <h3 className="text-xl font-bold text-white mb-3">
            Part of the Persistent Momentum portfolio
          </h3>
          <p className="text-slate-400 mb-6">
            {product.name} stands on its own. No forced bundles, no shared account, no lock-in.
            It&apos;s one of the products we design, build, and ship at Persistent Momentum.
          </p>
          <Link
            href="/products"
            className="inline-flex items-center gap-2 text-[#1E5BFF] font-medium hover:gap-3 transition-all"
          >
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-3xl mx-auto text-center">
        <Link
          href={`/products/${product.slug}/pricing`}
          className="inline-flex items-center gap-2 px-8 py-4 bg-[#1E5BFF] text-white font-semibold text-lg rounded-xl hover:scale-105 hover:shadow-2xl hover:shadow-[#1E5BFF]/50 transition-all duration-300"
        >
          See Pricing Plans
